...
"cols_digital += '<td class=\"align-middle\"> <label>DHT GPIO</label><select class=\"form-control h-25\" "
...
"value=\"sendmessagetelegram\">Send Telegram Message</option></select> <label><br />GPIO Target</label> "
